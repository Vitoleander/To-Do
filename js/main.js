window.addEventListener('load', () => {
    ...
    const list_el = document.querySelector("#tasks");           //lista med aktuella 
    const list_fi = document.querySelector("#task-finished");   //lista med färdiga
   

    form.addEventListener('submit', (e) => {
        e.preventDefault();         //stoppar uppdatering av sidan
        ...
        task_action_el.appendChild(task_save_el);
        ...
        /*task_save_el.addEventListener('click', () => {
            task_input_el=this.parentNode;
            task_input_el.append(task-finished);
        })*/
